  ...
  final List<Map<String, String>> faculty = [
    {
      ...
      'qualification': 'PhD (Computer Engineering), M.E. (Computer Engineering)',
      'experience': '22+ years',
      'specialization': 'Machine Learning, Data Mining, Big Data Analytics',
      'achievements': 'Published 50+ research papers, Guided 10 PhD students',
      'email': 'dskalbande@spit.ac.in',
    },
    {
      'name': 'Prof. Dr. Pooja Raundale',
      'position': 'Professor',
      'image': 'assets/prof_raundale.jpg',
      'qualification': 'PhD (Computer Science), M.Tech (Software Systems)',
      'experience': '13 years',
      'specialization': 'Software Engineering, Cloud Computing',
      'achievements': 'Awarded Best Teacher Award 2019, 3 patents filed',
      'email': 'pmraundale@spit.ac.in',
    },
    {
      'name': 'Prof. Dr. Aarti Karande',
      'position': 'Assistant Professor',
      'image': 'assets/prof_karande.png',
      'qualification': 'PhD (Computer Science), MCA',
      'experience': '19 years',
      'specialization': 'Artificial Intelligence, Natural Language Processing',
      'achievements': 'Google Certified Educator, 15+ international publications',
      'email': 'askarande@spit.ac.in',
    },
    {
      'name': 'Prof. Harshil Kanakia',
      'position': 'Assistant Professor',
      'image': 'assets/prof_kanakia.png',
      'qualification': 'M.Tech (Computer Science), Pursuing PhD',
      'experience': '8 years',
      'specialization': 'Blockchain Technology, Cybersecurity',
      'achievements': 'Certified Ethical Hacker, Industry consultant',
      'email': 'hkanakia@spit.ac.in',
    },
    {
      ...
      'achievements': 'Microsoft Certified Trainer, 5 research publications',
      'email': 'nkmangaonkar@spit.ac.in',
    },
    {
      'name': 'Prof. Sakina Shaikh',
      'position': 'Assistant Professor',
      'image': 'assets/prof_shaikh.png',
      'qualification': 'M.Tech (Computer Science), B.E. (IT)',
      'experience': '10 years',
      'specialization': 'Mobile Application Development, UI/UX Design',
      'achievements': 'Google Developer Expert, 3 apps published on Play Store',
      'email': 'snsaikh@spit.ac.in',
    },
  ];
        ...
        itemBuilder: (context, index) {
          return Card(
            ...
            child: InkWell(
              borderRadius: BorderRadius.circular(15),
              onTap: () {
                _showFacultyDetails(context, faculty[index]);
              },
              child: Padding(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 15),
              _buildDetailRow('Position', faculty['position']!),
              _buildDetailRow('Qualification', faculty['qualification']!),
...
class DeptInfo extends StatelessWidget {
  ...
  Widget _buildMissionSection(BuildContext context) {
    final missionStatements = [
      {
        'title': 'Academic Excellence',
        'description': 'To provide quality education through innovative teaching '
            'methodologies and state-of-the-art infrastructure to develop '
            'competent professionals in the field of Computer Applications.'
      },
      {
        'title': 'Research & Innovation',
        'description': 'To foster research culture among students and faculty by '
            'encouraging participation in research projects, publications and '
            'collaborations with industry and academia.'
      },
      {
        'title': 'Industry Connect',
        'description': 'To establish strong industry-academia partnerships through '
            'MOUs, internships, guest lectures and consultancy projects to bridge '
            'the gap between theoretical knowledge and practical applications.'
      },
      {
        'title': 'Holistic Development',
        'description': 'To nurture students\' overall personality development '
            'through various co-curricular and extracurricular activities, '
            'focusing on leadership, teamwork and ethical values.'
      },
      {
        'title': 'Social Responsibility',
        'description': 'To inculcate social awareness among students by engaging '
            'them in community development programs and projects that solve '
    ...
    return Column(
      ...
      children: [
        ...
        ...missionStatements.map((mission) =>
            _buildMissionPoint(
              context,
              missionStatements.indexOf(mission) + 1,
              mission['title']!,
              mission['description']!,
            ),
        ),
  ...
  Widget _buildMissionPoint(BuildContext context, int number, String title, String description) {
    return Card(
...
class FeedbackForm extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    const primaryColor = Color(0xFFF8F9FA);
    const secondaryColor = Color(0xFF2A5C82);
          ...
          child: Column(
            ...
            children: [
              ...
              RatingBar.builder(
                ...
                itemCount: 5,
                itemBuilder: (context, _) => Icon(Icons.star_rounded, color: accentColor),
